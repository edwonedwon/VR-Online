...
namespace BeardedManStudios.Network
{
	public class Networking
	{
		...
		///	}
		/// </example>
		public static NetWorker Connect(string ip, ushort port, TransportationProtocolType comType, bool winRT = false, bool useNat = false)
		{
			Unity.MainThreadManager.Create();
		...
		{
			NetworkingStream stream = new NetworkingStream().Prepare(netWorker, NetworkingStream.IdentifierType.Custom, null,
